...
class Pro {
  ...
  */
  ...
  // Input: 5;123, output: AnsiColor.index(123)
  ...
  // Input: 5;123, output: AnsiColor.index(123)
  private static var c256: P<AnsiColor> {
  ...
  // Input: 2;10;20;30, output: AnsiColor.rgb(10, 20, 30)
  private static var rgb: P<AnsiColor> {
  ...
  private static func toColorCode(_ location: String, _ color: AnsiColor) -> Code {
    switch location {
    case "38":
